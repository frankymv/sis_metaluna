...
<td style="width:198pt; padding-top: 10pt">
    <p class="s1" style="padding-left: 73pt;text-indent: 0pt;line-height: 12pt;text-align: left;">REPORTE DE ESTADO CUENTA CLIENTE</p>
</td>
...
<table style="border-collapse:collapse;margin-left:5.65pt" cellspacing="0">
    <tr style="height:13pt">
        ...
        <p class="s1" style="text-indent: 0pt;line-height: 12pt;text-align: center;">No</p>
        </td>
        <td style="width:350pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt" bgcolor="#FAE3D4">
    ...
    <tr style="height:13pt">
        ...
        <p class="s3" style="padding-left: 5pt;text-indent: 0pt;line-height: 12pt;text-align: left;">{{$data->no_estado}}</p>
        </td>
        <td style="width:350pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
            <p class="s3" style="padding-left: 5pt;text-indent: 0pt;line-height: 12pt;text-align: left;">Codigo: {{$data->cliente->codigo_mayorista}} Nombres: {{$data->cliente->nombres_cliente}}</p>
        </td>
        ...
        <td style="width:77pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
            <p class="s3" style="padding-left: 5pt;text-indent: 0pt;line-height: 12pt;text-align: left;">Q. {{$data->total_abono}}</p>
        </td>
        <td style="width:77pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
            <p class="s3" style="padding-left: 5pt;text-indent: 0pt;line-height: 12pt;text-align: left;">Q. {{$data->total_credito - $data->total_abono}}</p>
        </td>
