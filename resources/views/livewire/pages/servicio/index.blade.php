            ...
            <table class=" w-full">
                <thead>
                    <tr class="text-md font-semibold tracking-wide text-left text-gray-900 bg-gray-100 uppercase border-b">
                        ...
                        <th class="px-4 py-3 text-ms font-semibold border">no_servicio
                            <x-frk.components.filtro-input wire:model.live="filtroNoServicio" />
                        </th>
                        <th class="px-4 py-3">fecha_servicio
                            <x-frk.components.filtro-date-picker-range  label="Fecha"  />
                        </th>
                        <th class="px-4 py-3">total_servicio</th>
                        <th class="px-4 py-3">vehiculo_id
                            <x-frk.components.filtro-select wire:model.live="filtroVehiculo">
